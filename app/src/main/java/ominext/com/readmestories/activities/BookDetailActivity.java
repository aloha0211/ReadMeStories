...
public class BookDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_read) {
            ...
            if (RealmController.with(this).getBook(mBook.getId()) == null) {        // add to my books
                ...
                showConfirmationDialog(getString(R.string.remove_book), getString(R.string.remove_book_message), v -> {
    ...
    private void getBookContentFromFirebase() {
        ...
        htmlRef.getBytes(ONE_MEGABYTE).addOnSuccessListener(bytes -> {
            try {
